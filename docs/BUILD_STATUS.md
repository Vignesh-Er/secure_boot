...
| **Test Count (90)** | `tests/test_*.py` | Comprehensive test suite (90 test cases) | `pytest tests/` test collector execution | `eval/project_metrics.json` | Header Badge & Quickstart |
